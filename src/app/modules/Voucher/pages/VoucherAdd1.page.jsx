        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-9 m-auto">
              {/* <h2 className="fz-1a text-center">Thêm voucher loại 1</h2> */}
              <div className="form">
                <form onSubmit={handleSubmit(onHandSubmit)}>
                  <div className="row">
                    <div className="col-lg-6">
                      <div className="d-none">
                        <label className="mb-3 d-none" htmlFor>
                          Loại voucher
                      ...
                      <InputField
                        ...
                        name="customer_type"
                        readonly
                        value="Mặc định là KH đăng ký mới TK"
                        ref={register({
                          required: 'Hãy nhập đầy đủ thông tin'
                        })}
...
export default VoucherAdd1Page
