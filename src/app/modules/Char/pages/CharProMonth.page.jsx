...
function CharProMonth() {
    ...
    const onHandSubmit = async (data) => {
        const convertDate = data.month
        const arrayConvertDate = convertDate.split('-')
        console.log(arrayConvertDate)
        const newData = {
            month: arrayConvertDate[1],
            year: arrayConvertDate[0]
        }
        console.log(newData)
            ...
            <section className='d-flex align-items-center row'>
                ...
                <div className="col-lg-4">
                    <form onSubmit={handleSubmit(onHandSubmit)} className='d-flex align-items-center'>
                        <input type="month" id="start" className='form-control' name="month" ref={register} placeholder="chọn tháng" />
