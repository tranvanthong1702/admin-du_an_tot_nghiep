      ...
      {!layoutProps.offcanvas && (
        <Dropdown drop="down" alignRight>
          <Dropdown.Toggle as={DropdownTopbarItemToggler} id="kt_quick_notifications_toggle">
            <OverlayTrigger
              placement="bottom"
              overlay={<Tooltip id="user-notification-tooltip">{t('User Notifications')}</Tooltip>}
            >
              <div
            ...
            <form>
              ...
              >
                <h4 className="d-flex flex-center rounded-top">
                  <span className="text-white">{t('User Notifications')}</span>
                  <span className="btn btn-text btn-success btn-sm font-weight-bold btn-font-md ml-2 text-lowercase">
                    23 {t('new')}
                  </span>
                </h4>
                    ...
                    <Tab.Pane eventKey="Events" id="topbar_notifications_events">
                      ...
                      >
                        ...
                        <a href="#" className="navi-item">
                          <div className="navi-link">
                            <div className="navi-icon mr-2">
                              <i className="flatiron-download-1 text-danger" />
                            </div>
                            <div className="navi-text">
                              <div className="font-weight-bold">Finance report has been generated</div>
                              <div className="text-muted">25 hrs ago</div>
                        ...
                        <a href="#" className="navi-item">
                          <div className="navi-link">
                            <div className="navi-icon mr-2">
                              <i className="flatiron-security text-warning" />
                            </div>
                            <div className="navi-text">
